...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void register() async {
    // Check if form is valid and user agreed to terms
    if (_formKey.currentState!.validate() && agree) {
      ...
      try {
        ...
        // =======================================================
        //  ✅  *** بداية الإصلاح ***
        //  نتأكد هنا أن الصفحة ما زالت موجودة قبل استخدام context
        // =======================================================
      ...
      // =======================================================
      //  ✅  *** إصلاح إضافي لتحسين الكود ***
      //  نتأكد هنا أيضاً قبل إيقاف مؤشر التحميل
      // =======================================================
      if (context.mounted) {
        setState(() {
          loading = false;
